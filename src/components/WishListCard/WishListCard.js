    ...
    <>
        <div className='flex justify-between bg-gray-200 p-5 rounded-md shadow-md mb-8 mx-5'>
            ...
            <div className='item-center'>
                <h2 className='text-2xl text-gray-700 font-bold'>{item.product.name}</h2>
                <p className='mt-2 text-lg'> Price : <span className='text-green-700 italic' >{ item.product.price} </span>  </p>
