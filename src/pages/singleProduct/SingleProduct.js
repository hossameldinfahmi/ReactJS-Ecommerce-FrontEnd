                    ...
                    {/* <div className={classes.container}>
                            <div className={classes.imageIcon}>
                                ...
                                <div className={classes.icon}>
                                    <div className={classes.quantity}>{oneProduct.available_quantity}</div>
                            ...
                            <div className={classes.details}>
                                ...
                                <div className={classes.priceAvailability}>
                                    <p className={classes.available}>
                                        {
                                            oneProduct.available_quantity > 0 ? (<span>Incart</span>) : (<span>Out Of Stock</span>)
                                        }
                                    </p>
                                    <p className={classes.price}>${oneProduct.price}</p>
                                </div>
